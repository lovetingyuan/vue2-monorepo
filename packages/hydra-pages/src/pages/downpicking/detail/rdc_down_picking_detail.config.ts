  ...
  components: [
    {
      ...
      slots: [
        ...
        },
        {
          ...
          props: {
            ...
            tableConfig: {
              ...
              mode: 'row',
              recordCreatorProps:
                "{{ $.isViewable ? false : { position: 'bottom', creatorButtonText: '新增规则'} }}",
              // rules: {
        ...
        {
          type: 'MyText',
          props: { content: "{{model.ruleForm.businessType === 11 ? '默认打底规则：先进先出' : '默认打底规则：库位拣货优先级'}}", type: 'text', style: 'font-size: 12px;margin-left: 80px;color: #95989e;' },
        },
      ],
    }
  ],
